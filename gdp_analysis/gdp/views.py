...
def line(request):
    ...
    cds = ColumnDataSource(data=dict(country_years=year_data, country_gdps=gdp_data, names=c, colors=['red', 'blue', 'green']))
    ...
    fig.multi_line(source = cds, xs = "country_years", ys = "country_gdps", line_width = 2, legend_group='names', line_color='colors')
